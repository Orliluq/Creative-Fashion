...
const Home: NextPage<{ products: Product[]; categories: any }> = ({
  ...
  return (
    <div className='home'>
      <Head>
        <title>Creative Fashion Store</title>
      ...
      <section id='filler' className='w-full h-full relative'>
        <div className='absolute top-1/2 right-1/2'>
          ...
          <h1 className='text-black text-sm italic text-right'>
            - OrliDevs
          </h1>
        </div>
        <div className='w-full h-[30rem]'>
          <img
            ...
            src='https://images.pexels.com/photos/6347892/pexels-photo-6347892.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
          />
        </div>
      </section>
      <Categories categories={categories} />
      {/* <div className='w-full text-center py-20'>
        <h1 className='text-6xl font-bold'>Welcome creative</h1>
