...
function PaypalBtn() {
  ...
  useEffect(() => {
    const addPaypalScript = () => {
      ...
      script.src = `https://www.paypal.com/sdk/js?client-id=Abn_ToCvqxxObRALl0ll0S7_icCu4dZbIhWf_xDC7KpGbzxDZD6stXrDsuYaNvQQjf73qOa3rscfihtH&components=buttons,marks`;
      // script.src = `https://www.paypal.com/sdk/js?client-id=Abn_ToCvqxxObRALl0ll0S7_icCu4dZbIhWf_xDC7KpGbzxDZD6stXrDsuYaNvQQjf73qOa3rscfihtH`;
      script.async = true;
