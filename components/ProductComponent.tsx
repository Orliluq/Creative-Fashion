...
import type { Product } from '../types'; // Change the import to a type-only import
      ...
      <div className='flex justify-between max-w-[80rem] mx-auto gap-4 flex-col bg-white rounded-sm mb-20'>
        <div className='flex bg-white h-full items-center lg:flex-row flex-col lg:min-h-[calc(73vh)]'>
          ...
          <div className='basis-1/4 flex flex-col w-full p-4 justify-between h-full bg-[#DDC6A4] lg:min-h-[calc(73vh)]'>
            <div>
              <p className='bg-[#e63e57] px-2 py-1 my-2 w-max text-white rounded-sm'>
                {product.category}
              </p>
              <div className='pb-4'>
              ...
              <div>
                <div className='flex flex-col gap-2'>
                  <div className='py-2 flex w-full max-w-[6rem] justify-between'>
                    <span
                      id='minus'
                      className='text-xl  cursor-pointer flex-1 flex justify-center hover:bg-[#eeedec] bg-[#e9e8e6] text-white duration-100 ease-linear rounded-sm'
                    ...
                    <span
                      id='add'
                      className='text-xl cursor-pointer flex-1 flex justify-center hover:bg-[#dbdad7] bg-[#f3f1ef] text-white duration-100 ease-linear rounded-sm'
                      onClick={(e) => handleUpdateCount(e)}
                    >
                      &#43;
                    </span>
                  ...
                  <div className='flex w-full gap-x-2'>
                    ...
                    <button
                      className='w-12 items-center p-1 hover:bg-[#950707] bg-[#cb5d66] rounded-sm'
